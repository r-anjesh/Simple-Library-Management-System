            ...
            if(len(z.get())) < 5:
                ...
                if s.get().isdigit():
                    ...
                    if cas is None:
                        ...
                        insert()
#label and input
        Label(self,text="Register to ITS Library",font=("Algerian",35,'bold'),fg="white",bg="black").place(x=100,y=80)
        Label(self,text="Enter your details and click Register",font=("Arial",20,'bold'),fg="white",bg="black").place(x=200,y=600)
        Label(text = "Your Library Information",fg='white',font = ("Arial",13,"bold"),bg="black").place(x=300,y=220)
        ...
        Button( text="Register", width=10, font=("Arial", 13, "bold"), command=verify).place(x=300, y=550)
